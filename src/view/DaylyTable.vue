...
<template>
  ...
  <p class="title2" style="margin: 0px 50px;font-size: 28px;font-weight: bold;color: #888888">店面面积：100㎡</p>
...
export default {
  ...
  methods: {
    ...
    serach(){
      this.$router.push({
          path: '/daylytablesecond'
        })

    },
    initChart() {
      const progressChart = echarts.init(this.$refs.progressChart)
      const startTimeData = ['2023-04-16 10:00:00', '2023-04-16 12:00:00', '2023-04-16 14:00:00', '2023-04-16 16:00:00', '2023-04-16 18:00:00', '2023-04-16 20:00:00']
      const endTimeData = ['2023-04-16 12:00:00', '2023-04-16 14:00:00', '2023-04-16 16:00:00', '2023-04-16 18:00:00', '2023-04-16 20:00:00', '2023-04-16 22:00:00']
